...
class _FormsState extends State<Forms> {
  ...
  void _loadData() async {
    ...
    if (response.statusCode == 200) {
      //#5 tried also removing the setState here but it is not loading the json so i had to bring it back here
      // The  " ! " in the variable is a null checker and it is needed on a variable that does not accept null e.g String? or int?.
      setState(() {
