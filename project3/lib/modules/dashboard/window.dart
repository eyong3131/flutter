...
class _windowState extends State<window> {
  ...
  Future<void> _addUserAccount(BuildContext context) async {
    //Dialog box for adding new user account (WINDOW -> ASSIGNED -> ADD)
    return showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
  ...
  Future<void> _addProgram(BuildContext context) async {
    //Dialog box for adding new program (WINDOW -> PROGRAMS -> ADD)
    return showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
      ...
      child: Padding(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: Colors.white,
            border:
                Border.all(color: Color.fromARGB(255, 107, 107, 107), width: 2),
            borderRadius: BorderRadius.circular(10),
          ),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.stretch,
  ...
  Future<void> _addPurpose(BuildContext context) async {
    //Dialog box for adding new program (WINDOW -> PROGRAMS -> ADD)
    return showDialog(
        context: context,
        builder: (context) {
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: SingleChildScrollView(
            ...
            child: Table(
              border: TableBorder.all(
                  color: Color.fromARGB(255, 145, 144, 144), width: 2),
              children: [
                TableRow(
                  //header
                  children: [
